...
func (f *Crdclient) Create(obj *ctype.Crdcontroller) (*ctype.Crdcontroller, error) {
...
func (f *Crdclient) Update(obj *ctype.Crdcontroller, name string) (*ctype.Crdcontroller, error) {
	result := ctype.Crdcontroller{}
...
func (f *Crdclient) Get(name string) (*ctype.Crdcontroller, error) {
	result := ctype.Crdcontroller{}
	err := f.cl.Get().
		Namespace(f.ns).Resource(f.plural).
...
func (f *Crdclient) GetByVersion(version string) (*ctype.Crdcontroller, error) {

	clist, err := f.List(meta_v1.ListOptions{})
...
func (f *Crdclient) List(opts meta_v1.ListOptions) (*ctype.CrdcontrollerList, error) {
	result := ctype.CrdcontrollerList{}
	err := f.cl.Get().
		Namespace(f.ns).Resource(f.plural).
