...
const (
	CRDPlural      string = "crdcontrollers"
	...
	crd := &apiextv1beta1.CustomResourceDefinition{
		...
		Spec: apiextv1beta1.CustomResourceDefinitionSpec{
			...
			Names:   apiextv1beta1.CustomResourceDefinitionNames{
				Plural: CRDPlural,
				Kind:   reflect.TypeOf(ctype.Crdcontroller{}).Name(),
...
func ControllerNewClient(cfg *rest.Config) (*rest.RESTClient, *runtime.Scheme, error) {
